...
public partial class MAVLink
{
    ...
    public class MavlinkParse
    {
        ...
        public byte[] GenerateMAVLinkPacket10(MAVLINK_MSG_ID messageType, object indata, byte sysid = 255, byte compid = 0, int sequence = -1)
        {
            byte[] data;
        ...
        public byte[] GenerateMAVLinkPacket20(MAVLINK_MSG_ID messageType, object indata, bool sign = false, byte sysid = 255, byte compid= 0, int sequence = -1)
        {
            byte[] data;
